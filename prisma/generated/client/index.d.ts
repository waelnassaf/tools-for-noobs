...
export namespace Prisma {
  ...
  */
   ...
   * CategoryCountOutputType without action
   */
  export type CategoryCountOutputTypeCountToolsArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
  ...
  interface ToolFieldRefs {
    ...
    readonly desc: FieldRef<"Tool", 'String'>
    readonly slug: FieldRef<"Tool", 'String'>
    readonly categoryId: FieldRef<"Tool", 'Int'>
  }
  ...
  export interface Prisma__CategoryClient<T, Null = never, ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> extends Prisma.PrismaPromise<T> {
    ...
    tools<T extends Category$toolsArgs<ExtArgs> = {}>(args?: Subset<T, Category$toolsArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$ToolPayload<ExtArgs>, T, 'findMany'> | Null>;
   ...
   * Category.tools
   */
  export type Category$toolsArgs<ExtArgs extends $Extensions.Args = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the Tool
     */
    select?: ToolSelect<ExtArgs> | null
  ...
  export type ToolWhereInput = {
    ...
    desc?: StringFilter<"Tool"> | string
    slug?: StringNullableFilter<"Tool"> | string | null
    categoryId?: IntFilter<"Tool"> | number
  ...
  export type ToolScalarWhereWithAggregatesInput = {
    ...
    desc?: StringWithAggregatesFilter<"Tool"> | string
    slug?: StringNullableWithAggregatesFilter<"Tool"> | string | null
    categoryId?: IntWithAggregatesFilter<"Tool"> | number
  }
