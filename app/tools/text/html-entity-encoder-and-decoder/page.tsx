...
export default function HTMLEntityEncoderDecoder() {
    ...
    const pages = ["Home", "Text Tools", "HTML Entity Encoder and Decoder"]
    ...
    return (
        <>
            ...
            <div className="mt-12 padding-x padding-y max-width prose">
                <h1>HTML Entity Encoder and Decoder</h1>
                ...
                <div className="tool-content">
                    <h2>About HTML Entity Encoder and Decoder</h2>
                    <p>
                        This tool <b>HTML Entity Encoder and Decoder</b> is
                        essential for web development and data transmission. It
                        allows you to encode special characters into their
                        corresponding HTML entities, making the text safe for
                        use in HTML, and decode them back to their original
                        form.
                    </p>
                </div>
            </div>
