...
export default function Home() {
    ...
    const pages = ["Home", "Text Tools", "Base64 Text Encoder and Decoder"]
    ...
    const handleTextTransformation = (transformationType: string) => {
        if (textarea.current) {
            ...
            switch (transformationType) {
                ...
                case "decode":
                    try {
                        transformedText = atob(text)
                    } catch (e) {
                        transformedText = "Invalid Base64 string"
                    }
                    break
                default:
    ...
    return (
        <>
            ...
            <div className="mt-12 padding-x padding-y max-width prose">
                <h1>Base64 Text Encoder and Decoder</h1>
                <p>
                    Paste the text in the following input to encode or decode it
                    into/from Base64 format:
                </p>
                <textarea
                ...
                <div className="tool-content">
                    <h2>About Base64 Text Encoder and Decoder</h2>
                    <p>
                        This tool, <b>Base64 Text Encoder and Decoder</b>, is a
                        handy utility for encoding text into Base64 format and
                        decoding Base64 text back to its original form. Whether
                        you&apos;re a programmer, data analyst, or just dealing
                        with text transformations, this tool helps you
                        effortlessly convert text to and from Base64.
                    </p>
                </div>
            </div>
        </>
