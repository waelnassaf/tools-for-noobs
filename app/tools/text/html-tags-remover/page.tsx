...
export default function Home() {
    ...
    const pages = ["Home", "Text Tools", "HTML Tags Remover"]
    ...
    const handleTextTransformation = () => {
        ...
        if (text) {
            const transformedText = removeHtmlTags(text).trim()
    ...
    return (
        <>
            ...
            <div className="mt-12 padding-x padding-y max-width prose">
                <h1>HTML Tags Remover</h1>
                <p>
                    Paste the text in the following input to remove HTML tags:
                </p>
                <textarea
                ...
                <div className="tool-content">
                    <h2>About HTML Tags Remover</h2>
                    <p>
                        This tool <b>HTML Tags Remover</b> is a handy utility
                        for programmers, writers, or anyone who wants to clean
                        their text from HTML tags.
                    </p>
                </div>
            </div>
        </>
